            ...
            <div class="con_right clearFix">
                ...
                <div class="con_join">
                    ...
                    <div class="join_form">
                        ...
                        <div class="form_group">
                            <p>电话：</p>
                            <input type="text" placeholder="请输入真实电话" class="userTel"/>
                        </div>
                        <div class="form_group">
                            <p>联系时间：</p>
                            <select  id="" class="sel">
                                <option value="0" class="gray">请选择</option>
                                <option value="1" class="gray">工作日</option>
                                <option value="2" class="gray">周末</option>
                                <option value="3" class="gray">随时</option>
                            </select>
                        </div>
                        <div class="form_group">
                            <p>留言内容：</p>
                            <textarea  placeholder="请输入留言" class="con"></textarea>
                        </div>
                        <div class="form_group">
                            <p>购买方式：</p>
                            <input type="radio" name="buy_type" value="0"/><span>批发</span>
                            <input type="radio" name="buy_type" value="1"/><span>零食</span>
                        </div>
                        <div class="form_group">
                            <button>提交</button>
                        </div>
